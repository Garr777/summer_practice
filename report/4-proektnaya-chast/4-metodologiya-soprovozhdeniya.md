...
контуре ([раздел 2.1.6](../2-problematika/1-protivorechie.md)): за 47 суток
наблюдения число задач выросло примерно на 20 %, а число их групп — более чем
в полтора раза; 8,5 % задач имеют не более пяти прогонов. Это не разовое
пополнение, а постоянный приток, отражающий развитие кодовой базы.
...
построенный по принципам MLOps [32], [33]: автоматизация жизненного цикла
...
модель допускается к развёртыванию при его достижении [32], [33]. Для
...
триггерами, основанными на обнаружении дрейфа [34], [35].
...
реестр ([раздел Б.6](../7-prilozhenie-listingi.md)), благодаря чему
...
производственным системам машинного обучения [36]; в настоящей работе он
...
| Свойство | Классический контур MLOps [32], [33] | Механизмы платформы (VPA и аналоги) | Предлагаемая методология |
|---|---|---|---|
